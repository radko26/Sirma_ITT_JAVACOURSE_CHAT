...
/**
 * Loads {@link ResourceBundle} with property files and reads from them in dependence of the current locale.
 * 
 * @author Radoslav
 */
public class ContentLanguageManager {
	 ...
	 * @return
	 * String representing the abbreviation of the language.
	 */
